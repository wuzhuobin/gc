...
{    
	namespace Energy
	{
        /** First-order discrete energy class defined on a regular grid.
        
            This class represents a discrete first-order energy of the following type:
            \f[
            ...
            \f$ \mathcal{N} \f$ is a neighbourhood system containing all unordered
        ...
        */
        ...
        public:
            ...
            /** Unary clique potentials \f$ E_i \f$, i.e., label penalties (data costs). 
            ...
            */
            ...
            /** Pairwise clique potentials \f$ E_{ij} \f$, i.e., smoothness costs. 
